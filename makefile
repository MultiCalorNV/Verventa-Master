...
GLOBAL_DEFS = USE_HAL_DRIVER STM32F4XX HSE_VALUE=8000000 __STARTUP_CLEAR_BSS STM32F407VG USE_FULL_ASSERT __FPU_USED
...
INC_DIRS = Inc gui emWin emWin/config ../$(STMCUBE)/Drivers/CMSIS/Include ../$(STMCUBE)/Drivers/CMSIS/Device/ST/STM32F4xx/Include ../$(STMCUBE)/Drivers/STM32F4xx_HAL_Driver/Inc ../$(STMCUBE)/Drivers/CMSIS/Include ../$(STMCUBE)/Middlewares/ST/STemWin/inc .drivers/modbus ./drivers/display
...
SRCS_DIRS = Src gui gui/res emWin emWin/config emWin/os ../$(STMCUBE)/Drivers/STM32F4xx_HAL_Driver/Src ./drivers/modbus ./drivers/display
